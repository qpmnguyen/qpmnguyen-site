...
where $E_A$ is the expected score of player $A$ with rank $R_A$ playing against player $B$ of rank $R_B$. This is equivalent to applying the logistic function to a rescaled version of the difference in rankings   
