...
Broadly speaking, I'm interested in leveraging external information for variable selection and feature engineering for machine learning and statistical analysis in the context of high dimensional data sets. My current work primarily concerns the microbiome relative abundance data. Specifically, developing methods for:   

* Integrating taxonomy and functional annotation in microbiome-outcome analyses to present a more mechanistic look at the role of the microbiome in infant health.   
* Leveraging ecological interactions and microbe-specific features to enhance understanding of the role of individual microbes or microbial guilds in health outcomes.  
* Understanding microbiome colonization dynamics and how are they impacted by different exposures.      
...
*Submitted*  
[[Analysis Code](https://github.com/qpmnguyen/cILR_analysis)]  [[Package](https://github.com/qpmnguyen/teaR)]  [[Pre-print](https://www.biorxiv.org/content/10.1101/2021.09.07.459294v1)]  
